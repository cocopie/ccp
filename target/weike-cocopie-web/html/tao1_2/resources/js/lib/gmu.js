/* Gmu v2.1.0 - core/gmu.js, core/event.js, extend/parseTpl.js, core/widget.js, extend/throttle.js, extend/event.scrollStop.js, extend/matchMedia.js, extend/event.ortchange.js, extend/fix.js, widget/add2desktop/add2desktop.js, extend/highlight.js, widget/button/button.js, widget/button/$input.js, extend/touch.js, widget/calendar/calendar.js, widget/calendar/$picker.js, widget/dialog/dialog.js, extend/offset.js, extend/position.js, widget/dialog/$position.js, widget/popover/popover.js, widget/dropmenu/dropmenu.js, widget/dropmenu/horizontal.js, widget/dropmenu/placement.js, extend/iscroll.js, widget/gotop/gotop.js, widget/gotop/$iscroll.js, widget/historylist/historylist.js, widget/navigator/navigator.js, widget/navigator/$scrollable.js, widget/navigator/evenness.js, widget/navigator/scrolltonext.js, widget/panel/panel.js, widget/popover/arrow.js, widget/popover/collision.js, widget/popover/dismissible.js, widget/popover/placement.js, widget/progressbar/progressbar.js, widget/refresh/refresh.js, widget/refresh/$iOS5.js, widget/refresh/$iscroll.js, widget/refresh/$lite.js, widget/slider/slider.js, widget/slider/$autoplay.js, widget/slider/$lazyloadimg.js, widget/slider/$touch.js, widget/slider/arrow.js, widget/slider/dots.js, widget/slider/imgzoom.js, widget/suggestion/suggestion.js, widget/suggestion/$iscroll.js, widget/suggestion/$posadapt.js, widget/suggestion/$quickdelete.js, widget/suggestion/compatdata.js, widget/suggestion/renderlist.js, widget/suggestion/sendrequest.js, widget/tabs/tabs.js, widget/tabs/$ajax.js, widget/tabs/$swipe.js, widget/toolbar/toolbar.js, widget/toolbar/$position.js */
    ...
    gmu.Button.register('input', {
        ...
        toggle: function() {
            ...
            if ($el.is('input[type="radio"]')) {
                $radios = $("[name='" + $el.attr('name') + "']", $el[0].form || $el[0].ownerDocument || undefined);
...
(function(gmu, $, undefined) {
    ...
    gmu.define('Dialog', {
        ...
        destroy: function() {
            var opts = this._options,
                _eventHander = this._eventHandler;
    ...
    gmu.define('Historylist', {
        ...
        _bindUI: function() {
            ...
            me.$wrap.on('tap' + me.eventNs, function(ev) {
                ...
                if (!$target.hasClass('ui-historylist-itemwrap') && !($target = $target.parents('.ui-historylist-itemwrap')).length) {
                    $target = null;
                    return;
                }
...
(function(gmu, $, undefined) {
    ...
    gmu.define('Tabs', {
        ...
        _init: function() {
            var me = this,
                _opts = me._options,
                $el, eventHandler = $.proxy(me._eventHandler, me);
        ...
        _prepareDom: function(mode, _opts) {
            ...
            switch (mode) {
                case 'setup':
                    ...
                    if (_opts._nav) {
                        ...
                        _opts._nav.addClass('ui-tabs-nav').children().each(function() {
                            var $a = me._findElement('a', this),
                                href = $a ? $a.attr('href') : $(this).attr('data-url'),
                                id, $content;
                ...
                default:
                    ...
                    _opts._nav = $(this.tpl2html('nav', {
                        items: nav,
                        active: _opts.active
                    })).prependTo($el);
                    _opts._content = $(this.tpl2html('content', {
                        items: contents,
                        active: _opts.active,
                        transition: _opts.transition
                    })).appendTo($el);
...
(function($, undefined) {
    ...
    gmu.Tabs.register('ajax', {
        ...
        load: function(index, force) {
            ...
            if (index < 0 ||
                index > items.length - 1 || !(item = items[index]) || //如果范围错误
        ...
        _init: function() {
            ...
            me.on('ready', function() {
                ...
                if (opts.fixed) {
                    ...
                    insertBefore($el).append($el).append($el.clone().css({
                        'z-index': 1,
                        position: 'absolute',
                        top: 0
                    })),
                        top = $el.offset().top,
                        check = function() {
                            document.body.scrollTop > top ? $el.css({
                                position: 'fixed',
                                top: 0
